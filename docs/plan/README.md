# 파이네시스 — 비즈니스 기능 구현 계획 (Phase 문서 세트)
...
| 10 | [10-rebrand-phynesis.md](./10-rebrand-phynesis.md) | **리브랜딩** 그래플레이 비즈 → 파이네시스(PHYNESIS): 브랜드 표기·카피 일반화·카테고리 6개(마케팅·브랜딩·상권분석·투자·경영·인문교양)·외부 설정 체크리스트 | 00 | 📝 계획 |
