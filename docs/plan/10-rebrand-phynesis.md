...
4. ~~2차 액센트 골드~~ → **철회(2026-09-19)**: 골드 글씨 전부 제거. 라벨·번호는 slate-400, 다크 섹션 라벨은 brand-300, 무료 표시는 brand-600, 별점은 amber-400. 포인트 컬러는 네이비 하나.
...
"강의몰" 순서(카테고리 → 인기 → 최신)를 버리고 **문제 제시 → 콘텐츠 → 분야 → 철학 → 신뢰 → 가입** 으로 재배열.
